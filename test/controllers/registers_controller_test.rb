...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { course: @register.course, date_of_registration: @register.date_of_registration, module: @register.module, name: @register.name, registration: @register.registration } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { course: @register.course, date_of_registration: @register.date_of_registration, module: @register.module, name: @register.name, registration: @register.registration } }
